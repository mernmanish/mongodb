...
export const environment = {
  ...
  siteURL: 'http://192.168.65.151:4201/',
  serviceURL: 'http://192.168.65.151/irms/admin/',
  websiteserviceURL: 'http://192.168.65.151/irms/CMSadmin/api/',
  fileUrl: 'http://192.168.65.151/irms/admin/storage/uploads/images/',
  domainUrl:'http://192.168.65.151/irms/CMSadmin/',
  cmsdomainUrl:'http://192.168.65.151/irms/CMSadmin/',  
  irmsHomeUrl: 'http://192.168.65.151:4201/assets/images/',
  tempUrl:'http://192.168.65.151/irms/admin/'+'storage/temp/',
  serviceAdminURL: 'http://192.168.65.151/irms/admin/',
  apiUrl: 'http://192.168.65.151/irms/admin/',
  installURL:'http://192.168.65.151/',
  staticFileUrl:'http://192.168.65.151:4201/assets/files/SampleForm.pdf',
  staticUserManualFileUrl:'http://192.168.65.151:4201/assets/files/OIMS-UserManual.pdf',
